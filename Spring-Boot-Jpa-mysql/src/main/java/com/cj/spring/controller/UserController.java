...
public class UserController {
    ...
    public ResponseEntity<User> getUserById(@PathVariable("id") long id) {
	 ...
	 public List<User> getByNameAndCountryAndState(@PathVariable String name, @PathVariable String country,@PathVariable String state) {	 
	  List<User> tasks=userService.findByNameAndCountryAndState(name, country,state);
	  return tasks;
